...
>>>>>>> 16ac31a1372d9ff862820ec6a4488a78feb5cf54
    ...
    for mentee in mentees:
        ...
        citizenship = db.execute("SELECT citzenship FROM rankings WHERE person_id = ?", (mentee, ))
        ...
        for mentor in mentors:
            ...
            if mentor_count > 0: 
                ...
                db.execute("INSERT INTO matches (score, mentee_id, mentor_id) VALUES (?,?,?)", (0, mentee, 0))
                status = 0    
