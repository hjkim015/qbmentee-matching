...
# Count the number of mentors in the database
    ...
    for mentee in mentees:
        ...
        # Checks to see if there are no more mentors, and if that is the case, puts remaining mentees on a waitlist
            if mentor_count == 0:
                db.execute("INSERT INTO matches (score, mentee_id, mentor_id) VALUES (?,?,?)", (mentee, 0, ))
            else:
